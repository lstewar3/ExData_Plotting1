...
globalReactivePower <- as.numeric(subSetHouseholdPowerData$Global_reactive_power)
voltage <- as.numeric(subSetHouseholdPowerData$Voltage)
subMetering1 <- as.numeric(subSetHouseholdPowerData$Sub_metering_1)
subMetering2 <- as.numeric(subSetHouseholdPowerData$Sub_metering_2)
subMetering3 <- as.numeric(subSetHouseholdPowerData$Sub_metering_3)
